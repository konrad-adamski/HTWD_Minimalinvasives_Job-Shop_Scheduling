...
class ProductionSimulation:
    ...
    def _init_machines(self, dframe_schedule_plan):
        unique_machines = dframe_schedule_plan["Machine"].unique()
        self.machines = {m: Machine(self.env, m) for m in unique_machines}
    ...
    def run(self, dframe_schedule_plan: pd.Dataframe,start_time=0, end_time=None):
        self.start_time = start_time
        self.end_time = end_time
        self.env = simpy.Environment(initial_time=start_time)
        self._init_machines(dframe_schedule_plan)
